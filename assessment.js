...
var secondHero = heroes.slice(3, 1);
...
// #16 Create a function called callerBack that takes in a function (holla) and a string parameter(back) and invokes
//it(holla) with the argument string(back) + ' back'."
